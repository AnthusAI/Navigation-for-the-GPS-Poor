...
def load_results():
    ...
    # Load actual model performance characteristics from simple baseline
    results_path = '../artifacts/simple_baseline_eval_results.pkl'
...
def create_main_article_plot(gt_coords, pred_coords, errors, background_map,
    ...
    ax.text(0.5, 0.04, 'CNN Terrain Navigation: Individual Position Predictions',
    ...
    print(f"Main trajectory plot saved to {output_path}")
